...
│
├── server.js  
          # Серверная часть (WebSocket + HTTP)  
├── index.html  
...
│  
├── users.json  
         # База пользователей (создаётся автоматически, НЕ В GIT)  
├── messages.json  
      # База сообщений (создаётся автоматически, НЕ В GIT)  
│  
...
🌙 Тёмная тема  #✅ Добавлена в релизе v1.1.0
